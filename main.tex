...
Road salt is indispensable for winter road safety, yet it is also a leading cause of the widespread salinization of fresh waters across cold-climate regions \citep{kaushal2005,dugan2023}. Sodium chloride has been the standard road de-icing agent in North America and Europe since the 1940s, and its use has climbed steadily ever since \citep{tiwari2018,bubeck1971,jackson2005}. It is effective only within limits---roughly above $-12$~$^{\circ}$C (10~$^{\circ}$F) on frozen surfaces---yet in practice it is routinely applied outside those limits, such as during rain or when temperatures are too low for it to work. This over-application persists because salt is inexpensive and easy to spread, while the cost of the alternative---roadway accidents---is high, so users consistently err toward applying more than is needed. That excess is the root of the long-term human and environmental problems examined below \citep{jamshidi2020}.
