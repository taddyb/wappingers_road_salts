...
Sodium chloride was adopted as a routine road de-icing agent in both North America and Europe beginning in the 1940s \citep{tiwari2018}, and usage of the chemical has since skyrocketed and continues to increase at an accelerated rate \citep{bubeck1971,jackson2005}. While useful at temperatures above -12~$^{\circ}$C (10~$^{\circ}$F), road salts are often overused in situations in which they have minimal effect. Examples of this include application during rain or below the minimum sufficient temperature. A reason why users are more likely to over-salt is the affordable cost, and the potentially high alternative costs of roadway accidents. Road salts are cheap to purchase and easy to use, thus the overapplication of road salts has caused many significant long-term human and environmental issues \citep{jamshidi2020}.
